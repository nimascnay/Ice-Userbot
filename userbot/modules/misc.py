...
async def killdabot(event):
    ...
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID,
            "**#SHUTDOWN** \n"
            "**Ｉｃｅ-Userbot** telah di matikan!\nJika ingin menghidupkan kembali silahkan buka heroku",
        )
    await event.edit("`Ｉｃｅ-Userbot Berhasil di matikan!`")
...
async def killdabot(event):
    await event.edit("**Ice-Userbot Berhasil di Restart**")
    if BOTLOG:
        await event.client.send_message(
...
async def reedme(e):
    await e.edit(
        ...
        "\n🦄 [Userbot Repo](https://github.com/nimascnay/Ice-Userbot/blob/Ice-Userbot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        ...
        f"❀ **Group mutualan :** [channel](https://t.me/moodlychannel)\n"
